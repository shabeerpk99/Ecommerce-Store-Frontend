  ...
  return (
    <footer className="bg-white">
      <Container className="py-10">
        <div className="grid gap-8 lg:grid-cols-[auto_1fr]">
          <div className="max-w-[276px]">
            <Logo />
            <p className="mt-4 text-lg leading-6 tracking-tight text-gray-600">
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              ...
              <a
                href="#"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-[#BDC4CD] text-white hover:bg-[#A0A8B1] transition-colors"
                aria-label="Facebook"
              >
          ...
          <div className="grid gap-8 items-start lg:grid-cols-[3fr_1fr]">
            ...
            <div className="lg:self-start">
              ...
              <div className="mt-4 space-y-2">
                ...
                <a
                  href="#"
                  className="flex h-10 w-[140px] items-center gap-2 rounded-md bg-dark px-3 hover:bg-gray-800 transition-colors"
                >
                  ...
                  <div className="flex flex-col items-start">
                    <span className="text-[9px] text-white/80 leading-none">Download on the</span>
                ...
                >
                  ...
                  <div className="flex flex-col items-start">
                    <span className="text-[9px] text-white/80 leading-none">GET IT ON</span>
      ...
      <div className="border-t border-gray-300 bg-gray-200">
        <Container className="flex flex-col gap-3 py-5 md:flex-row md:h-[68px] md:items-center md:justify-between">
